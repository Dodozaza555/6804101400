<template>
  <q-page class="q-pa-md">
    <q-form class="q-gutter-md" style="max-width: 600px">
      ...
      <q-input filled label="Your name (ชื่อ-นามสกุล)*" hint="Name and surname" />
...
function onSubmit () {
  if (accept.value !== true) {
    $q.notify({ type: 'negative', message: 'You need to accept the license and terms first' })
  } else {
    $q.notify({ type: 'positive', message: 'Submitted successfully' })
  }
}
